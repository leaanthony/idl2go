...
func _ICoreWebView2NewBrowserVersionAvailableEventHandlerInvoke(this *ICoreWebView2NewBrowserVersionAvailableEventHandler, webviewEnvironment *ICoreWebView2Environment, args *_IUnknown) uintptr {
	return this.impl.NewBrowserVersionAvailable(webviewEnvironment, args)
}

type _ICoreWebView2NewBrowserVersionAvailableEventHandlerImpl interface {
	_IUnknownImpl
	NewBrowserVersionAvailable(webviewEnvironment *ICoreWebView2Environment, args *_IUnknown) uintptr
}
